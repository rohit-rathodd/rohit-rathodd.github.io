!function(e, t) {
    ...
    function I(t) {
        return "object" === e(t) && null != t && !k(t) && !A(t)
    }
    function O(e) {
        return null == e
    }
    ...
    function j(e, t, i, n) {
        ...
        if (a && (C(a) && (s = x('<div class="ginlined-content">'.concat(a, "</div>"))),
        E(a))) {
    ...
    var V = function() {
        function e() {
            ...
            I(i) && (this.defaults = r(this.defaults, i))
        }
        return n(e, [{
            key: "sourceType",
            value: function(e) {
            ...
            value: function(e, t) {
                ...
                return e.width = P(e, "width") && "" !== e.width ? this.checkSize(e.width) : i,
                e.height = P(e, "height") && "" !== e.height ? this.checkSize(e.height) : n,
                e
            }
        }, {
            key: "checkSize",
        ...
        return n(e, [{
            ...
            value: function() {
                ...
                var n = this.instance.settings
                  , s = this.slideConfig
                  , l = T();
                k(n.beforeSlideLoad) && n.beforeSlideLoad({
                    index: this.index,
                    slide: t,
                    player: !1
                });
                ...
                if (k(n.afterSlideLoad) && (v = function() {
                    k(i) && i(),
                    n.afterSlideLoad({
                        index: e.index,
                        slide: t,
                ...
                "video" !== o) {
                    if ("external" !== o)
                        return "inline" === o ? (j.apply(this.instance, [t, s, this.index, v]),
                        void (n.draggable && new W({
                            dragEl: t.querySelector(".gslide-inline"),
                            toleranceX: n.dragToleranceX,
                            toleranceY: n.dragToleranceY,
                            slide: t,
                            instance: this.instance
                        }))) : void ("image" !== o ? k(v) && v() : function(e, t, i, n) {
                    ...
                    (function(e, t, i, n) {
                        ...
                        w(this.settings.plyr.js, "Plyr", function() {
                            ...
                            var S = P(s.settings.plyr, "config") ? s.settings.plyr.config : {}
                              , w = new Plyr("#" + o,S);
                            ...
                            w.on("enterfullscreen", H),
                            w.on("exitfullscreen", H)
                        })
                    }
                    ).apply(this.instance, [t, s, this.index, v])
            }
        }, {
            key: "slideShortDesc",
            value: function(e) {
                ...
                n.innerHTML = e;
                var s = i;
                if ((e = n.innerText.trim()).length <= t)
                    return e;
                var l = e.substr(0, t - 1);
                return s ? (n = null,
                l + '... <a href="#" class="desc-more">' + i + "</a>") : l
            }
        }, {
      ...
      , R = T()
      , G = null !== T() || void 0 !== document.createTouch || "ontouchstart"in window || "onmsgesturechange"in window || navigator.msMaxTouchPoints
      ...
      , U = function() {
        ...
        return n(e, [{
            ...
            value: function() {
                ...
                var i = X(t) ? t : this.settings.startAt;
                if (E(e)) {
                ...
                d(s, "glightbox-open"),
                d(Z, "glightbox-open"),
                R && (d(document.body, "glightbox-mobile"),
                ...
                this.lightboxOpen = !0,
                this.trigger("open"),
                k(this.settings.onOpen) && this.settings.onOpen(),
                G && this.settings.touchNavigation && function(e) {
                    if (e.events.hasOwnProperty("touch"))
                        return !1;
                    var t, i, n, s = b(), l = s.width, o = s.height, r = !1, a = null, h = null, c = null, f = !1, m = 1, y = 1, x = !1, S = !1, w = null, T = null, k = null, C = null, E = 0, A = 0, L = !1, I = !1, O = {}, P = {}, M = 0, X = 0, z = document.getElementById("glightbox-slider"), Y = document.querySelector(".goverlay"), q = new N(z,{
            ...
            value: function() {
                ...
                k(this.settings.slideRemoved) && this.settings.slideRemoved(e)
            }
        }, {
            key: "slideAnimateIn",
            value: function(e, t) {
                ...
                t)
                    f(e, this.settings.cssEfects[this.settings.openEffect].in, function() {
                        ...
                        k(i.settings.afterSlideChange) && i.settings.afterSlideChange.apply(i, [l, o])
                    });
                else {
            ...
            value: function() {
                ...
                !O(this.settings.elements) && A(this.settings.elements) && this.settings.elements.length && a(this.settings.elements, function(i, n) {
                    var s = new F(i,e,n)
                      , l = s.getConfig()
                      , o = r({}, l);
                    o.node = !1,
            ...
            value: function() {
                ...
                if (this.built)
                    return !1;
                var t = P(this.settings.svg, "next") ? this.settings.svg.next : ""
                  , i = P(this.settings.svg, "prev") ? this.settings.svg.prev : ""
                  , n = P(this.settings.svg, "close") ? this.settings.svg.close : ""
                    ...
                    i || n) {
                        ...
                        n)
                            if (l <= 768) {
                                ...
                                h.setAttribute("style", "max-height: calc(100vh - ".concat(a, "px)")),
                                s.setAttribute("style", "max-width: ".concat(h.offsetWidth, "px;"))
                            }
                        if (i) {
                            var c = (P(this.settings.plyr.config, "ratio") ? this.settings.plyr.config.ratio : "16:9").split(":")
                              , v = 900
                              , f = v / (parseInt(c[0]) / parseInt(c[1]));
                            if (f = Math.floor(f),
                            r && (o -= s.offsetHeight),
                            o < f && l > v) {
                                var p = i.offsetWidth
                                ...
                                i.parentNode.setAttribute("style", "max-width: ".concat(x.width, "px")),
                                r && s.setAttribute("style", "max-width: ".concat(x.width, "px;"))
                            } else
                                i.parentNode.style.maxWidth = "".concat(v, "px"),
                                r && s.setAttribute("style", "max-width: ".concat(v, "px;"))
                        }
                    }
                }
            }
            ...
            value: function() {
                ...
                f(this.activeSlide, this.settings.cssEfects[this.settings.closeEffect].out, function() {
                    ...
                    e.trigger("close"),
                    k(e.settings.onClose) && e.settings.onClose();
